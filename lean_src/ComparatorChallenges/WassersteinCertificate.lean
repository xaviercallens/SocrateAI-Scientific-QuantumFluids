/- GENERATED by scripts/make_comparator_challenges.py from lean_src/WassersteinCertificate.lean.
...
theorem toy_certificate (τ : Fin 6 ≃ Fin 6) : ∑ i, C i (σ i) ≤ ∑ i, C i (τ i) := by
  sorry
