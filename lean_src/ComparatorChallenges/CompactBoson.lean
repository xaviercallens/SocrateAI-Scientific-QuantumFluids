/- GENERATED by scripts/make_comparator_challenges.py from lean_src/CompactBoson.lean.
...
theorem dim_electric (R : ℝ) : dim R 1 0 = 1 / R ^ 2 := by
  sorry
/-- The magnetic (vortex) dimension. -/
theorem dim_magnetic (R : ℝ) : dim R 0 1 = R ^ 2 / 4 := by
  sorry
