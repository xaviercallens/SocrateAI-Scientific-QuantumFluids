...
PAPERS = ["causal_topology.pdf", "astro_topological_measurement.pdf", "sector_temperature.pdf"]
LEAN = ["TopologicalProtection.lean", "ScaleResolvedWinding.lean", "ContinuumWinding.lean", "SectorTemperature.lean", "QHFricke.lean", "VortexWinding.lean", "QuantizedCirculation.lean"]
