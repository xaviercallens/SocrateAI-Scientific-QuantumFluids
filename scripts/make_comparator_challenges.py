...
SOLUTIONS = ["QuantumFluidsShell", "MadelungSplit", "Duality", "GPGalerkin", "ShellHamiltonian", "DualLength", "RipsFloor", "SigmaRule", "MadelungNSE", "VortexWinding", "QuantizedCirculation", "HeliumKinematics", "BoseIntegral", "PhononSeries", "PhononSpecificHeat", "ZeroSound", "PhaseMixing", "Villani", "WassersteinCertificate", "Fricke", "QHFricke"]
